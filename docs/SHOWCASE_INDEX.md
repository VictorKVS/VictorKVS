...
6. `Sokrat` — evidence-gated research prototype / iterative research lineage
7. `devsafe` — developer safety / DevSecOps product candidate after end-to-end proof
8. canonical Universal Agent implementation after audit
9. canonical Librarian AI implementation after audit
10. `META-FOUNDRY` — ecosystem/meta-engineering layer
11. future verified MVP products generated by the ecosystem
